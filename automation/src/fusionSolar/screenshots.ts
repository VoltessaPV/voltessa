...
/** tmp/fusionsolar/ - shared by every screenshot this module writes. */
 ...
 *  callers writing other files into the same directory can reuse this
 *  instead of duplicating the mkdir call. */
